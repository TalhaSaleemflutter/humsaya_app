...
import 'package:humsaya_app/views/auth/forget_password.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> googleSignIn() async {
    ...
    await authProvider.googleSignIn(context: context);
    // await fetchData();
  }
  ...
  Future<void> signIn(BuildContext context) async {
    ...
    try {
      ...
      if (!hasInternet) {
        ...
        cupertinoDialog(context, 'Please connect to the internet to place order');
        return;
      }
      final authProvider = Provider.of<AuthProvider>(context, listen: false);
      
      String result = await authProvider.signInWithEmail(
        userModel: UserModel(
          uid: '',
          name: '',
          phoneNo: '',
